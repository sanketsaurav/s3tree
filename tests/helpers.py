...
def generate_dummy_bucket():
    ...
    session = Session(aws_access_key_id=DUMMY_ACCESS_KEY_ID,
    ...
    files = (
        ...
        'cache/foo.rb', 'cache/staticfiles/latest/index.js'
        'cache/staticfiles/dummy.txt', 'cache/staticfiles/logs.txt'
    )
